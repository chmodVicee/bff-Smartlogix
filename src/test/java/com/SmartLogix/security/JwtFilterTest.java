...
class JwtFilterTest {
    ...
    @Test
    void testDoFilterInternalWithoutHeader() throws ServletException, IOException {
    ...
    @Test
    void testDoFilterInternalWithInvalidHeaderPrefix() throws ServletException, IOException {
